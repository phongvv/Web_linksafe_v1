...
<html lang="en">
  <head>
    ...
    <!--external css-->
    <link href="/api/assets/font-awesome/css/font-awesome.css" rel="stylesheet" />
  ...
  <body onload="getTime()">
	  				...
	  				<div class="lock-screen">
				          ...
				          <div aria-hidden="true" aria-labelledby="myModalLabel" role="dialog" tabindex="-1" id="myModal" class="modal fade">
				              <!-- <div class="modal-dialog">
				                  <div class="modal-content">
				                      ...
				                      <div class="modal-body">
				                          <p class="centered"><img class="img-circle" width="80" src="/api/assets/img/ui-sam.jpg"></p>
                              ...
                              <div class="col-lg-4 col-lg-offset-4 col-md-6 col-md-offset-3 login-box-locked">
                                    ...
                                    <img class="avatar" src="/api/assets/img/photo7.jpg">
    ...
    <script>
        $.backstretch("/api/assets/img/login-bg.jpg", {speed: 500});
    </script>
