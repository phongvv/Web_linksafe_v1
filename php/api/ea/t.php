...
button_cancel('policy');
if ($checks == true) {

    $url = "http://$serverip/api/policy/" . $_SESSION['edge_id'];
    $url1 = "http://$serverip/api/scenario/" . $_SESSION['edge_id'];
        ...
        if ($_POST['actions'] == 'save') {
            ...
            if (!$input_errors) {
                ...
                if ($api_result['message'] == "null") {
                    ...
                    if ($id) {
                        header("Location:create_policy?id=$id");
                        exit;
                    } else {
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="input-group mb-3">
                                            ...
                                            <div class="col-sm-8">
                                                ...
                                                <select name="scenario" id="scenario" class="form-control select2" style="width: 100%;">
                                                    <!-- <option selected="selected">None</option> -->
                                                    <?php
                                                    $list = get_scenario("all");
                                                    $list_arrr = $list['data'];
                                                    foreach ($list_arrr as $o) {
                                                        if ($o['edge_id'] == $edge_id) {
                                                            $list_arrx[] = $o;
                                                        }
                                                    }
                                        ...
                                        <div class="input-group mb-3">
                                            ...
                                            <div class="col-sm-8">
                                                <select name="group" id="group" class="form-control select2" style="width: 100%;">
                                                    <!-- <option selected="selected">None</option> -->
                                                    <?php
                                                    $group = show_group(false);
                                                    foreach ($group as $cc => $vl) {
                                                        echo '<option value="' . $cc . '">' . $vl . '</option>';
                                                    } ?>
                                                </select>
                                            </div>
                                        ...
                                        <div class="input-group mb-3">
                                            ...
                                            <div class="col-sm-8">
                                                <select name="device" id="device" class="form-control select2" style="width: 100%;">
                                                    <!-- <option selected="selected">None</option> -->
                                                    <?php
                                                    $device = get_end_device($_SESSION['edge_id'], true);
