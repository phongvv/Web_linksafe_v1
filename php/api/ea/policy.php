...
if ($checks == true) {
    ...
    if ($statuss == true) {
        $url = "http://$serverip/api/policy/" . $_SESSION['edge_id'];
                                ...
                                <div class="col-12">
                                    <div class="card card-info">
                                        <div class="card-header">
                                            <h3 class="card-title"><b style="text-align: center!important;"><u>Policy List</u></b></h3>
                                        </div>
                                        <div class="card-body">
                                                ...
                                                <tbody>
                                                    ...
                                                    ?>
                                                                <tr>
                                                                    ...
                                                                    <td><?= htmlspecialchars($test = get_scenario(true)[$result['scenario_id']]); ?>
                                                                    </td>
                                                                    ...
                                                                    switch ($result['source_type']) {
                                                                        case "0":
                                                                    ?>
                                                                            <td><?= htmlspecialchars($test = get_end_device($_SESSION['edge_id'], true)[$result['source']]); ?></td>
                                                                        <?php
                                                                            break;
                                                                        case "1":
                                                                        ?>
                                                                    ...
                                                                    <td>
                                                                        <a class="fa fa-pen" title="<?= $gettext_array['edit'] ?>" role="button" href="create_policy?id=<?= $iii ?>"></a>
                                            ...
                                            <nav class="action-buttons">
                                                <div style="text-align:right;">
                                                    <a href="create_policy" role="button" class="btn bg-gradient-success btn-sm">
