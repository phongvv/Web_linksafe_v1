...
;(function ( $, window, document, undefined ) {
    ...
    Plugin.prototype._create = function () {
        ...
        // this.element.append('<input type="password" class="' + options.inputClass + '" id ="' + options.idClass + '"/>');
        this.element.append('<input type="text" class="' + options.inputClass + ' "  style="display:none" placeholder="Password" onblur =" '  + "check()" + '"  />');
        ...
        this.element.append(
            ...
            <li data-criterion="special" class="valid">One <strong>special characters</strong></li> \
            <li data-criterion="    " class="valid">No spaces</li> \
            </ul> \
            </div>');
