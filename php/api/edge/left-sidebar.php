    ...
    <div class="sidebar">
        ...
        <nav class="mt-2">
            <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
                ...
                <!--    Network  ---->
                <li class="nav-item  <?php isActive("interface","partial") ?> ">
                    <a href="#" class="nav-link <?php isActive("interface") ?> ">
                    ...
                    <ul class="nav nav-treeview ">
                        <li class="nav-item <?php isActive("interface") ?>" >
                ...
                <li class="nav-item ">
                    <a href="../redirect" class="nav-link ">
                        <i class="fa fa-rotate-left"></i> <span>Return Dashboard</span>
