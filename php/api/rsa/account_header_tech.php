        ...
        <div class="col-md-12">
            <div class="card card-info">
                <div class="card-header with-border" style="text-align: center;">
                    <h3 class="card-title">SSA Tech List</h3>
                </div>
                <!-- /.card-header -->
                <div class="card-body">
                    ...
                    <nav class="action-buttons">
                        <div style="text-align:right;">
                            <a  href="create_ssa_tech" role="button" class="btn bg-gradient-success btn-sm">
