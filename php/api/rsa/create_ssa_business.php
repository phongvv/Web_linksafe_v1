...
button_cancel('account?id=ssa-business');
if ($checks == true) {
    if ($_REQUEST["id"] != '') {
        $id = $_REQUEST["id"];
    ...
    if ($_POST['action'] == 'save') {
        ...
        if (!$input_errors) {
            ...
            if ($api_result["message"] != "null") {
                ...
                header("Location: create_ssa_business?id=$id");
                exit;
            } else {
                if ($method == "PATCH") {
                    $input_success[] = sprintf(gettext("Edit SSA business successful!"));
                } else if ($method == "POST") {
                    $input_success[] = sprintf(gettext("Create SSA business successful!"));
                }
...
?>
                                ...
                                <div class="card card-info">
                                    <div class="card-header" style="text-align: center;">
                                        <h3 class="card-title">SSA Business Create</h3>
                                    </div>
                                    <form action="create_ssa_business" method="post" class="form-horizontal">
                                        <input id="id" type="hidden" name="id" value="<?= $id ?>" />
                                        <div class="card-body">
                                            <div class="input-group mb-3">
                                                <label for="inputEmail3" class="col-sm-2 control-label" <?php if ($id != "") { ?> disabled <?php } ?>>Username<red>*</red></label>
                                            ...
                                            <div class="input-group mb-3">
                                                ...
                                                <div class="col-sm-8">
                                                    <input type="text" class="form-control" name="full_name" required="required" id="full_name" placeholder="...">
                                                </div>
                                            </div>
                                            <div class="input-group mb-3">
                                            ...
                                            <div class="input-group mb-3">
                                                ...
                                                <div class="col-sm-8">
                                                    <input type="text" class="form-control" name="number_phone" required="required" id="number_phone" placeholder="...">
                                                </div>
                                            </div>
                                            <div class="input-group mb-3">
