        ...
        <div class="col-md-12">
            <div class="card card-info">
                <div class="card-header with-border" style="text-align: center;">
                    <h3 class="card-title">SSA Business List</h3>
                </div>
                <!-- /.card-header -->
                <div class="card-body">
                        ...
                        <tbody>
                            ...
                            ?>
                                    <tr>
                                        ...
                                        <td>
                                            <a class="fa fa-pencil" title="<?= $gettext_array['edit'] ?>" role="button" href="create_ssa_business?id=<?= $i ?>"></a>
                                            <a class="fa fa-trash no-confirm" title="<?= $gettext_array['del'] ?>" role="button" data-toggle="modal" data-target="#myModal<?= $result['id'] ?>"></a>
                                            <?php
                                            $link = "account?id=ssa-business&&";
                                            $id = $result['id'];
                    ...
                    <nav class="action-buttons">
                        <div style="text-align:right;">
                            <a href="create_ssa_business" role="button" class="btn bg-gradient-success btn-sm">
