...
button_cancel('account?id=ssa-customer');
if ($checks == true) {
    // phpsession_begin();
    ...
    if ($_POST['action'] == 'save') {
        ...
        if (!$input_errors) {
            ...
            if ($api_result["message"] != "null") {
                ...
                header("Location: create_ssa_customer?id=$id");
                exit;
            } else {
                if ($method == "PATCH") {
                    $input_success[] = sprintf(gettext("Edit SSA customer successful!"));
                } else if ($method == "POST") {
                    $input_success[] = sprintf(gettext("Create SSA customer successful!"));
                }
                            ...
                            <div class="col-md-12">
                                ...
                                <div class="card card-info">
                                    <div class="card-header" style="text-align: center;">
                                        <h3 class="card-title">SSA Customer Create</h3>
                                    </div>
                                    <form action="create_ssa_customer" method="post" class="form-horizontal">
                                        ...
                                        <div class="card-body">
                                            ...
                                            <div class="input-group mb-3">
                                                ...
                                                <div class="col-sm-8">
                                                    <input type="text" class="form-control" name="full_name" required="true" id="full_name" placeholder="....">
                                                </div>
                                            </div>
                                            <div class="input-group mb-3">
