        ...
        <div class="col-md-12">
            <div class="card card-info">
                <div class="card-header with-border">
                    <h3 class="card-title">Technical List</h3>
                </div>
                <!-- /.card-header -->
                <div class="card-body">
                        ...
                        <tbody>
                            ...
                            ?>
                                    <tr>
                                        ...
                                        <td>
                                            <a class="fa fa-pen" style="width: 25px" title="<?= $gettext_array['edit'] ?>" role="button" href="add_tech?id=<?= $i ?>"></a>
                                            <!-- <a class="fa fa-trash no-confirm"	title="<?= $gettext_array['del'] ?>"	role="button" href="account?id=1&&idd=<?= $result['id'] ?>"></a> -->
                                            ...
                                            $link = "account?id=1&&";
                                            $id = $result['id'];
                                            $string = 'Are you sure to delete Technical Account "' . $result["username"] . '"';
                    ...
                    <nav class="action-buttons">
                        <div style="text-align:right;">
                            <a href="add_tech" role="button" class="btn bg-gradient-success btn-sm">
